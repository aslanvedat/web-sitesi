...
import { Box, Tab, Button, Card, CardActions, CardContent, CardMedia, Typography } from "@mui/material"
        ...
        <Box >
            <TabContext value={value}>
                <Box sx={{ borderBottom: 1, borderColor: "divider", width: "%90" }}>
                    <TabList aria-label="Tabs example" onChange={handleChange} textColor="secondary" centered variant="scrollable" scrollButtons="auto" >
